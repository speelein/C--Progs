// Ritchis Texteditor mit Registry-Zugriffen
...
class RitchisTexteditor : Form {
	RichTextBox editor;
	MenuItem mitNew, mitSaveAs, mitUndo, mitCut, mitCopy, mitPaste, mitDel, mitFind, mitFindNext, mitSelectAll,
	...
	protected override void OnLoad(EventArgs ea) {
		...
		if (userKey != null) {
			try {
				...
				MessageBox.Show("Fehler beim Laden der Einstellungen", appName, MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
			userKey.Close();
		}
	}
	...
	protected override void OnClosed(EventArgs ea) {
		...
		try {
			...
			MessageBox.Show("Fehler beim Speicher der Einstellungen", appName, MessageBoxButtons.OK, MessageBoxIcon.Error);
		} finally {
			userKey.Close();
		}
	}
