...
class RitchisTexteditor : Form {
	...
	public RitchisTexteditor() {
		...
		// Menüitems Datei
		Bitmap bmp = new Bitmap("open.bmp");
		...
		mitEdit.DropDownItems.AddRange(new ToolStripItem[] {mitUndo, mitRedo, new ToolStripSeparator(),
			...
			new ToolStripSeparator(), mitSelectAll, new ToolStripSeparator(), mitFind});
		...
		// Menüitems Extras
		mitBackColor = new ToolStripMenuItem("&Hintergrundfarbe...", null, MitBackColorOnClick);
